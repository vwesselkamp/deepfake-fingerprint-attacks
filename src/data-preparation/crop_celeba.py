"""This script for cropping CelebA was taken directly from: https://github.com/RUB-SysSec/GANDCTAnalysis/blob/master/crop_celeba.py
It is only included here for consistency and quick access.
...
def crop_image(stupid):
    ...
    if file_path.endswith("png") or file_path.endswith("jpeg") or file_path.endswith("jpg"):
        ...
        # celeba has format (218, 178)
        # crops image around center (121, 89)
